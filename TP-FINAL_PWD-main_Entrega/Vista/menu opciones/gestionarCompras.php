...
?>
                <div class="container-fluid" style="margin-bottom: 19%">
                    <?php //VENTANA PARA VISUALIZAR LOS PRODUCTOS Y SUS DETALLES QUE SE INGRESARON EN LA COMPRA, ?>
                    <div class="modal fade" id="exampleModalToggle2" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
                        <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title text-black" id="exampleModalToggleLabel">Productos de la compra</h1>
                    ...
                    <?php //VENTANA PARA VISUALIZAR EL HISTORIAL DE LA COMPRA. INCLUYE QUIEN REALIZO LA COMPRA Y EL ESTADO ACTUAL DE LA MISMA, ?>
                    <div class="modal fade" id="exampleModalToggle1" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
                        <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title text-black" id="exampleModalToggleLabel">Historial de compra</h1>
                                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body row">
                                    <div>
                    ...
                    <?php //SE GENERA LA TABLA DE LAS COMPRAS REALIZADAS, TRAYENDO SUS RESPECTIVOS DATOS ?>
                    <div class="container col-md-10 text-white mt-5">
                        <h2 class="text-black">Gestionar Compras:</h2>
