...
<div class="">
        ...
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <div>
                <a class="link-light col-md-3" data-bs-toggle="modal" href="#exampleModalToggle2" role="button">
                    <img id="logo_carrito" src="../img/pngwing.com (3).png" class="img-fluid w-25" alt="Logo de Carrito">
                </a>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title text-black" id="exampleModalToggleLabel">Detalles del Producto</h1>
    ...
    <div class="modal fade" id="exampleModalToggle2" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title text-black" id="exampleModalToggleLabel">Carrito</h1>
                    <button type="button" class="btn-close btn-close-black" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body row">
                    <div>
                                            ...
                                            if ($arrayCompraItem != null) {
                                                foreach ($arrayCompraItem as $compraItem) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                        <a href="#" class="eliminar_producto_carrito color-white">
            ...
            <div class="tarjetas-productos" onclick="verDetalle(this)">
                <a class="link-light" data-bs-toggle="modal" href="#exampleModalToggle1" role="button">
                    ...
                    <div class="tarjeta-producto__info">
                        <p class="nombre__producto" style="color: black;">' . $producto->getNombre() . '</p>
